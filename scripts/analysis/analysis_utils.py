...
DEFAULT_TASKS_DIR = REPO_ROOT / "data" / "selected_33w"
DEFAULT_RENDERS_DIR = REPO_ROOT / "data" / "path_video_frames_random_humans_33w"
DEFAULT_ASSIGNMENTS_JSON = REPO_ROOT / "data" / "actor_assignments_w_ban_33w.json"
FRAME_STEP_WORLD = 0.05
FRAME_THRESHOLDS = [30, 60, 90]

_MPL_CACHE = REPO_ROOT / ".matplotlib-cache"
