...
Usage:
  ./chingmu_progress.py
  ./chingmu_progress.py --planned-root /path/to/plans --video-root /path/to/videos
...
def count_files_one_level(root: Path, suffix: str) -> Dict[str, int]:
    """
...
def main() -> None:
    ...
    planned = count_files_one_level(args.planned_root, ".json")
    videos = count_files_one_level(args.video_root, ".mp4")
