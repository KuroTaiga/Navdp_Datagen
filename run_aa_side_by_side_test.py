...
def main() -> int:
    ...
    scenes_dir = Path(os.getenv("SCENES_DIR", script_dir / "data" / "scenes"))
    tasks_dir = Path(os.getenv("TASKS_DIR", script_dir / "data" / "CHINGMU_75_rescaled_0800_42_iter1"))
    output_root = Path(os.getenv("OUTPUT_ROOT", script_dir / "data" / "aa_side_by_side_test"))
