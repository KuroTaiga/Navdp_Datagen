...
except Exception:  # pragma: no cover - render-only installs do not need simple_knn
    distCUDA2 = None
...
class GaussianModel:
    ...
    def create_from_pcd(self, pcd : BasicPointCloud, cam_infos : int, spatial_lr_scale : float):
        ...
        if distCUDA2 is None:
            raise ImportError("simple_knn is required for training/create_from_pcd, but not for PLY rendering.")
